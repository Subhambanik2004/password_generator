...
def generator():
    ...
    inp=small_alphabets+capital_alphabets+numbers+special_char
    ...
    if (choice.get()==3):
        passwordField.insert(0,random.sample(inp,password_length))
    #password=random.sample(inp,passowrd_length)
...
passwordLabel=Label(root,text='Password Length',font=Font,bg='midnight blue',fg='white')
